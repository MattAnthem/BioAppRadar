...
const AltitudeSlider = (
  { 
    ...
    const position_classes: Record<Position, string> = {
        right: "right-2 lg:bottom-[13%] bottom-[25%]",
        left: "left-2 lg:bottom-[13%] bottom-[25%]"
    }

  return (
    <div className={`${position_classes[position]} ${className} absolute z-10 isolate border-white/20 bg-gray-900/50 shadow-md ring-1 ring-black/5 backdrop-blur-sm text-gray-100 w-22 max-h-[65vh] lg:h-[65vh] h-[35vh]  rounded-sm p-2 flex justify-start items-center`}>
        ...
        {altitudes.map((alt: number, i: number) => (
            ...
            <div  className="w-full flex items-start justify-center">
                <button
                  ...
                  } w-4  lg:h-2 h-1 relative cursor-pointer hover:bg-blue-800`}
                >
                  {
                    (i === currentIndex) && (
