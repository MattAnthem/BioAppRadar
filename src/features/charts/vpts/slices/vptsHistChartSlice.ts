...
export const { changeVptsHistPayload, setSelectedVptsHistParameterOption, setVptsHistEndTime, setVptsHistStartTime, setSelectedVptsHistSpecie } = vptsHistChartSlice.actions;
